...
body <- dashboardBody( 
  tabItems(  
    ...
    tabItem(tabName = "detalle1",
            ...
            fluidRow(
              box(
                ...
                width = 12,
                br(), br(),
                highchartOutput("COG_TOTAL_M",height = "500px"),
    ...
    tabItem(tabName = "pronos1",
            h1(paste0("Proyección del gasto corriente en el Gobierno Central para el ",Ano_actual, "."), align = "center"),
            br(),
    ...
    tabItem(tabName = "pronos2",
            h1(paste0("Resumen mensual y proyección del gasto en el Gobierno Central para el año ", Ano_actual,"."),align = "center"),
            br(),
            fluidRow(
              box(
            ...
            fluidRow( 
              box(
                title = paste0("Proyección del gasto corriente del Gobierno Central para el presente año (millones) ", Ano_actual,"."), status = "warning",
                solidHeader = TRUE, 
                width = 8,
    ...
    tabItem(tabName = "pronos3",
            h1(paste0("Proyección por título del gasto corriente del Gobierno Central para el ",Ano_actual, "."), align = "center"),
            br(),
    ...
    tabItem(tabName = "pronos4",
            h1(paste0("Resumen mensual y proyección del gasto por título en el Gobierno Central para el ano ", Ano_actual,"."), align = "center"),
            br(),
            ...
            fluidRow(
              box(
                title = paste0("Resumen y proyeccioó mensual de los gastos corrientes en el ", Ano_actual, ", según el título seleccionado (en millones)."), status = "primary",
                reactableOutput("Ejecutado2_1") 
                
              ),
              
              box(
                title = paste0("Proyección del gasto corriente, según el titulo seleccionado, para el ", Ano_actual, "."), status = "warning",
    ...
    tabItem(tabName = "alertas",
            h1(paste0("Indicadores sobre la verificación la Regla Fiscal en el Gobierno Central ", Ano_actual, "."), align = "center"),
            br(),
            fluidRow(
              box(
              ...
              box(
                h4(paste0("Proyección del gasto corriente total en el Gobierno Central para el año ", Ano_actual, " (en millones)."), align = "center"), 
                br(), 
                status = "primary",
            ...
            fluidRow(
              ...
              box(
                title = paste0("Se cumplira el criterio de la Regla Fiscal para el año ", Ano_actual, ":"), status = "primary",
